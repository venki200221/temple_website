...
<body>
  {{-- @include('cookie-consent::index'); --}}
                 ...
                 <button type="button" class="btn btn-primary ">ಗ್ಯಾಲರಿ</button>
                  ...
                  <div class="btn-group nav-link nav-item ">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="/">ಆಂಗ್ಲ</a>
                      <a class="dropdown-item" href="/telgu">ತೆಲುಗು</a>
                      <a class="dropdown-item" href="/telgu">ಕನ್ನಡ</a>
                      <a class="dropdown-item" href="/hindi">ಹಿಂದಿ</a>                      
                    </div>
                  </div>
    ...
    <div class="top">
      <h1 class="temple_name">ಶ್ರೀ ವೇಣುಗೋಪಾಲ ಸ್ವಾಮಿ ದೇವಸ್ಥಾನ</h1>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <center><h3 style="font-family: 'Arima Madurai'">ನಮ್ಮ ಬಗ್ಗೆ</h3></center>
          ...
          <div class="carousel-item" style="background-color:#FFF8F3" id="donate" >
           <center><h3 style="font-family: 'Arima Madurai'">ನಮಗೆ ದಾನ ಮಾಡಿ</h3></center>
